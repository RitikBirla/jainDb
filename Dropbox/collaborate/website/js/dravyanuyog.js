...
function addType() 
{
  ...
  for(i=0; i<allItems.categories.length; i++) {
    ...
    for(j=1; j<allItems[curType]+1; j++) {
      ...
      document.write("<li><a href=\"jainDataBase/dravyanuyog/"+curType+"/"+obj.name+"/html/0000_introduction.html\"><font size=4>"+myName+"</font></a></li>");
    }
