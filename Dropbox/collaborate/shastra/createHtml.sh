...
outDir=$(find $dbDir/Public/HTML/myWebsite/jainDataBase/$ggDir -name $pDir -type d)
echo "Will Create HTML files here - $outDir"
/bin/rm -rf $outDir/html
mkdir -p $outDir/html
/bin/cp -f $dbDir/collaborate/$ggDir/$gDir/$pDir/index.txt $outDir/index.txt 
/bin/cp -f $dbDir/collaborate/$ggDir/$gDir/index.txt $outDir/../index.txt 
/bin/cp -f $dbDir/collaborate/$ggDir/index.txt $outDir/../../index.txt 
